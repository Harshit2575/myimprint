...
<body>
  ...
  <div class="fixed-action-btn" style="bottom: 295px; right: 0px;">
    <a class="btn btn-large red modal-trigger animated fadeInRight" href="#modal1" style="padding-left: 40px;padding-right: 40px">VOTE NOW</a>
  </div>
      ...
      <div class="row">
        <div class="col l4 s12 m7 offset-l1" style="width: 250px">
          <div class="card hoverable">
            ...
            <div class="card-content">
              <center><p>Vaibhav Chauhan<br>Students' Alumni Cell G-Sec</p></center>
            </div>
          </div>
        </div>
        <div class="col l4 s12 m7"style="width: 250px">
          <div class="card hoverable">
            ...
            <div class="card-content">
              <center><p>Mridul Pant<br>Students' Alumni Cell G-Sec</p></center>
            </div>
          </div>
        </div>
        <div class="col l4 s12 m7"style="width: 250px">
          <div class="card hoverable">
            ...
            <div class="card-content">
              <center><p>Shovan Panigrahi<br>Vice President, Gymkhana</p></center>
            </div>
          </div>
        </div>
      </div>
